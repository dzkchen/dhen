...
import io.github.dzkchen.dhen.sound.SoundPitchAccess;
...
public abstract class AbstractSoundInstanceMixin implements SoundPitchAccess {
	@Shadow
	protected float pitch;

	@Override
	public float dhenSourcePitch() {
		return this.pitch;
	}
	...
	private float dhen$applyRuleVolume(final float original) {
		...
		return original * SoundManager.volumeOf(sound.getIdentifier(), this.pitch);
	}
}
